...
const ADMIN_NUMBER = 'whatsapp:+5491154540307';
const ADMIN_MAIL = 'arieldumpierres@hotmail.com';

const transporter = createTransport({
    host: 'smtp.gmail.com',
    port: 587,
    auth: {
        user: 'arieldumpierres@gmail.com',
...
class OrderDAOMongoDB extends contenedorMongoDB {
    ...
    async createOrder(req, res) {
        ...
        .then(async (_) => {
            ...
            //       from: '+15704634266',
            //       to: `+541154540307`, //acá debería ser orderData.client.phone, mis usuarios son de prueba asi que pongo mi numero
